...
res = http.CallHttp(
    ...
    success_syntax="string",
    success_criteria="status_code>=500",
    # success_criteria=["status_code>=500","status_code>=200" ],
    # success_criteria=["status_code", ">=", "500"],
    # success_criteria=[["status_code", ">=", "500"], ["status_code", ">=", "500"]],
).run()

# pawn.console.log(f"res={res.response}, success={res.response.success}")
pawn.console.log(f"res={res.response}")
pawn.console.log(f"res={res.success_criteria}")
