...
def main():
    complex_urls = [
        ...
        "http://20.20.5.196",
        {
            "url": "http://20.20.5.196/index.html",
            "method": "get",
        },
        {
            "url": "http://20.20.5.196",
            "method": "post",
        },
    ]
    async_http = run.AsyncHttp(debug=False, status=True, urls=complex_urls)
    # for url_list in complex_urls:
    #     async_http.append_task(url_list)
