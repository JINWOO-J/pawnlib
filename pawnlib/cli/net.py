...
def get_arguments(parser):
    ...
    parser.add_argument('-w', '--worker', type=int, help='Max concurrency worker count', default=30)
...
def main():
    ...
    if args.command == "check":
        ...
        scanner = net.AsyncPortScanner(host_range, port_range, max_concurrency=args.worker)
        scanner.run_scan()
